...
He creado este repositorio para compartir datos, el proceso, su análisis y figuras. Siéntanse libres de analizarlo, replicarlo, corregirlo y mejorarlo. Una diferencia con el que compartieron es que yo tomé la serie de tiempo desde el primer año, me parece que es una diferencia significativa y es necesario tomarla en cuenta.
